        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div key={item} className="relative group overflow-hidden rounded-lg aspect-square bg-primary-gray">
                <div className="absolute inset-0 bg-gradient-to-br from-accent to-primary-dark opacity-50 group-hover:opacity-0 transition-opacity duration-300" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <Camera className="text-primary-light mx-auto mb-2" size={48} />
                    <p className="text-primary-light font-semibold">Project {item}</p>
                  </div>
                </div>
              </div>
            ))}
